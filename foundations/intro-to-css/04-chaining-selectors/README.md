...
### Self Check
- Did you properly chain class selectors for each rule? OK
- Does the `proportioned` image retain its original square proportions? OK
- Does the `distorted` image end up looking squished and, well, distorted? OK
